...
Il problema principale nella generazione del codice per i riferimenti agli elementi di un array consiste nel correlare i calcoli dell'indirizzo visti nel paragrafo 7.10.2 alla grammatica corrispondente.
...
\subsubsection{Esempio 6.12: Albero Annotato}
...
\textbf{Figura 6.23 - Albero di parsing annotato:}
